...
class ProfileSnapshotRecord(Base):
    ...
    rating_1_count: Mapped[int | None] = mapped_column(Integer)
    rating_2_count: Mapped[int | None] = mapped_column(Integer)
    rating_3_count: Mapped[int | None] = mapped_column(Integer)
    rating_4_count: Mapped[int | None] = mapped_column(Integer)
    rating_5_count: Mapped[int | None] = mapped_column(Integer)
